                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-20">
                        ...
                        <div className="flex flex-col justify-between h-full">
                            <div>
                                ...
                                <p className="text-slate-600 text-lg mb-8 leading-relaxed font-medium">
                                    Whether you&apos;re scaling an enterprise agentic system or integrating
                                    custom LLMs, our engineering team is ready to deploy.
                                </p>

                                <div className="flex flex-col gap-5">
                                    {[
                                        { icon: "architecture", text: "Free 30-min architecture review" },
                                        { icon: "security", text: "Enterprise-grade security" },
                                        { icon: "rocket_launch", text: "Custom deployment strategy" },
                                    ].map((item, i) => (
                                        <div
                                            key={i}
                        ...
                        <div className="bg-white border border-slate-100 rounded-[2rem] p-6 md:p-8 shadow-[0_8px_40px_rgba(0,0,0,0.08)] relative overflow-hidden">
                            ...
                            <form className="flex flex-col gap-5 relative z-10">
                                ...
                                <button
                                    type="button"
                                    className="group mt-2 w-full h-14 bg-primary text-white font-bold text-lg rounded-xl hover:shadow-[0_4px_20px_rgba(70,19,236,0.4)] hover:scale-[1.01] transition-all flex items-center justify-center gap-2"
                                >
                                    Initialize Project
